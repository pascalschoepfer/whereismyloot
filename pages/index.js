...
const Home = () => {
    const [bananaPrice, setBananaPrice] = useState(0.00019)
    const [charmzPrices, setCharmzPrices] = useState([0,0.0019, 0.01, 0.15])
    ...
    const [shredzPrice, setShredzPrice] = useState(0.029)
    const [goldenTicketPrice, setGoldenTicketPrice] = useState(0.37)
