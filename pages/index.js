...
const Home = () => {
    ...
    const [charmzPrices, setCharmzPrices] = useState([0,0.004, 0.026, 0.3])
    ...
    const [shredzPrice, setShredzPrice] = useState(0.032)
    const [goldenTicketPrice, setGoldenTicketPrice] = useState(0.42)
