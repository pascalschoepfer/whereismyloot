...
const Home = () => {
    const [bananaPrice, setBananaPrice] = useState(0.00021)
    const [charmzPrices, setCharmzPrices] = useState([0,0.003, 0.02, 0.25])
    ...
    const [embLegePrice, setEmbLegePrice] = useState(0.9)
